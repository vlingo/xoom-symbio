...
/**
 * The reader for a given {@code ObjectStore}, which is provided by its {@code entryReader()} method.
 * The {@code Entry<T>} instances are appended by the {@code ObjectStore} {@code persist(...)} methods.
 ...
 */
public interface ObjectStoreEntryReader<T extends Entry<?>> extends EntryReader<T> { }
