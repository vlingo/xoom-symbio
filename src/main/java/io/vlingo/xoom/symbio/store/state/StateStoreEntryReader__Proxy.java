...
public class StateStoreEntryReader__Proxy<T extends io.vlingo.xoom.symbio.Entry<?>> implements io.vlingo.xoom.symbio.store.state.StateStoreEntryReader<T> {
  ...
  @Override
  public io.vlingo.xoom.common.Completes<java.lang.Long> size() {
    if (!actor.isStopped()) {
      final SerializableConsumer<StateStoreEntryReader> consumer = (actor) -> actor.size();
      final io.vlingo.xoom.common.Completes<java.lang.Long> completes = Completes.using(actor.scheduler());
  ...
  @Override
  public io.vlingo.xoom.common.Completes<T> readNext(java.lang.String arg0) {
    if (!actor.isStopped()) {
      final SerializableConsumer<StateStoreEntryReader> consumer = (actor) -> actor.readNext(arg0);
  ...
  @Override
  public io.vlingo.xoom.common.Completes<java.util.List<T>> readNext(java.lang.String arg0, int arg1) {
    if (!actor.isStopped()) {
