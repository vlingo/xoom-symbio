...
public class StateStoreReadResultInterest__Proxy<T> implements ReadResultInterest<T> {
  ...
  private static final String readResultedInRepresentation1 = "readResultedIn(io.vlingo.symbio.store.Result, java.lang.String, io.vlingo.symbio.State<T>)";
  private static final String readResultedInRepresentation2 = "readResultedIn(io.vlingo.symbio.store.Result, java.lang.Exception, java.lang.String, io.vlingo.symbio.State<T>)";
  ...
  public void readResultedIn(io.vlingo.symbio.store.Result arg0, java.lang.String arg1, io.vlingo.symbio.State<T> arg2, final Object arg3) {
    if (!actor.isStopped()) {
  ...
  @SuppressWarnings({ "rawtypes", "unchecked" })
  public void readResultedIn(io.vlingo.symbio.store.Result arg0, java.lang.Exception arg1, java.lang.String arg2, io.vlingo.symbio.State<T> arg3, final Object arg4) {
    if (!actor.isStopped()) {
